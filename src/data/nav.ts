export const services = [
  ...
  { label: 'Corporate Entertainment', href: '/corporate-magician' },
  { label: 'Holiday Party Magician', href: '/holiday-party-magician' },
  { label: 'Trade Show Magician', href: '/trade-show-magician' },
  { label: 'Birthday Party Magician', href: '/birthday-party-magician-and-mentalist' },
  { label: 'Wedding Magician', href: '/wedding-magician' },
  { label: 'Private Party Magician', href: '/private-party-magician' },
];
